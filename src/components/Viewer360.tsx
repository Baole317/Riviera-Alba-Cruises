...
const Viewer360: React.FC<Viewer360Props> = ({ url, onClose, hotspots, currentId, onNavigate, onUpdateHotspot, lastDrop, isViewerMode }) => {
  ...
  useEffect(() => {
    ...
    // Add other hotspots to the scene
